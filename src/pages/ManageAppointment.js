...
const ManageAppointment = () => {
    ...
    const fetchAppointments = async () => {
        try {
            const response = await axios.get('https://my-app-1007139059424.europe-west3.run.app/api/admin/appointments');
    ...
    const handleDelete = async (row) => {
        try {
            await axios.delete(`https://my-app-1007139059424.europe-west3.run.app/api/appointments/${row.donorEmail}`); 
...
const updateAppointment = async (donorEmail, updatedData) => {
    try {
        const response = await axios.put(`https://my-app-1007139059424.europe-west3.run.app/api/appointments/${donorEmail}`, updatedData);
